                ...
                <Tooltip delayDuration={100}>
                    <TooltipTrigger asChild>
                        <button
                            ...
                            className={cn(
                                'bg-neutral-400 hover:bg-neutral-500 absolute top-1 left-1 rounded-md p-1.5 flex items-center justify-center transition',
                                isIncome && 'bg-emerald-500 hover:bg-emerald-600',
                                isExpense && 'bg-rose-500 hover:bg-rose-600',
                            )}
                        >
                            {!parsedValue && <IconInfoCircle className="size-4 text-white" />}
                            {isIncome && <IconPlus className="size-4 text-white" />}
                            {isExpense && <IconMinus className="size-4 text-white" />}
                        </button>
                    </TooltipTrigger>
